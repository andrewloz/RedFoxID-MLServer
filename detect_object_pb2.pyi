...
class RequestPayload(_message.Message):
    __slots__ = ("image_rgba_bytes", "image_width", "image_height", "confidence_threshold", "iou_threshold", "image_name", "model_name")
    ...
    image_name: str
    model_name: str
    def __init__(self, image_rgba_bytes: _Optional[bytes] = ..., image_width: _Optional[int] = ..., image_height: _Optional[int] = ..., confidence_threshold: _Optional[float] = ..., iou_threshold: _Optional[float] = ..., image_name: _Optional[str] = ..., model_name: _Optional[str] = ...) -> None: ...
