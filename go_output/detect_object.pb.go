...
func (x *BoxXYWH) Reset() {
	*x = BoxXYWH{}
	mi := &file_detect_object_proto_msgTypes[0]
...
func (*BoxXYWH) Descriptor() ([]byte, []int) {
	return file_detect_object_proto_rawDescGZIP(), []int{0}
}
...
func (x *Detection) Reset() {
	*x = Detection{}
	mi := &file_detect_object_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Detection) Descriptor() ([]byte, []int) {
	return file_detect_object_proto_rawDescGZIP(), []int{1}
}
...
func (x *ResponsePayload) Reset() {
	*x = ResponsePayload{}
	mi := &file_detect_object_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResponsePayload) Descriptor() ([]byte, []int) {
	return file_detect_object_proto_rawDescGZIP(), []int{2}
}
...
type RequestPayload struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Raw RGBA image bytes (height * width * 4 bytes)
...
func (x *RequestPayload) Reset() {
	*x = RequestPayload{}
	mi := &file_detect_object_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RequestPayload) Descriptor() ([]byte, []int) {
	return file_detect_object_proto_rawDescGZIP(), []int{3}
}
...
var File_detect_object_proto protoreflect.FileDescriptor

const file_detect_object_proto_rawDesc = "" +
	"\n" +
	"\x13detect_object.proto\"A\n" +
	"\aBoxXYWH\x12\f\n" +
...
var (
	file_detect_object_proto_rawDescOnce sync.Once
	file_detect_object_proto_rawDescData []byte
)

func file_detect_object_proto_rawDescGZIP() []byte {
	file_detect_object_proto_rawDescOnce.Do(func() {
		file_detect_object_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_detect_object_proto_rawDesc), len(file_detect_object_proto_rawDesc)))
	})
	return file_detect_object_proto_rawDescData
}

var file_detect_object_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_detect_object_proto_goTypes = []any{
	(*BoxXYWH)(nil),         // 0: BoxXYWH
	(*Detection)(nil),       // 1: Detection
	(*ResponsePayload)(nil), // 2: ResponsePayload
	(*RequestPayload)(nil),  // 3: RequestPayload
}
var file_detect_object_proto_depIdxs = []int32{
...
func init() { file_detect_object_proto_init() }
func file_detect_object_proto_init() {
	if File_detect_object_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_detect_object_proto_rawDesc), len(file_detect_object_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_detect_object_proto_goTypes,
		DependencyIndexes: file_detect_object_proto_depIdxs,
		MessageInfos:      file_detect_object_proto_msgTypes,
	}.Build()
	File_detect_object_proto = out.File
	file_detect_object_proto_goTypes = nil
	file_detect_object_proto_depIdxs = nil
}
