...
type RequestPayload struct {
	...
	ImagePngBytes []byte `protobuf:"bytes,1,opt,name=image_png_bytes,json=imagePngBytes,proto3" json:"image_png_bytes,omitempty"`
...
func (x *RequestPayload) GetImagePngBytes() []byte {
	if x != nil {
		return x.ImagePngBytes
	}
	return nil
}
...
const file_protos_detect_object_proto_rawDesc = "" +
	...
	".DetectionR\aobjects\"\x92\x02\n" +
	"\x0eRequestPayload\x12&\n" +
	"\x0fimage_png_bytes\x18\x01 \x01(\fR\rimagePngBytes\x12\x1f\n" +
